    ...
    <template v-if="venue" slot="default">
      <section class="venue">
        ...
        <div class="venue-info">
          <b-link :href="mapsUrl" class="venue-info__link venue-info__link--address" target="_blank">
          ...
          <b-link v-if="venue.website" :href="venue.website" class="venue-info__link venue-info__link--website" target="_blank" rel="noreferrer">
            <span class="icon-prefix">
          ...
          <b-link v-if="venue.email" :href="`mailto:${venue.email}`" class="venue-info__link venue-info__link--email">
            <span class="icon-prefix">
              <svg style="width:24px;height:24px" viewBox="0 0 24 24">
          ...
          <b-link v-if="venue.phone_number" :href="`tel:${venue.phone_number}`" class="venue-info__link venue-info__link--phone">
            <span class="icon-prefix">
              <svg style="width:24px;height:24px" viewBox="0 0 24 24">
          ...
          <div class="venue-social">
            <b-link v-if="untappd" :href="untappd" class="btn venue-untappd" target="_blank" rel="noreferrer">
            ...
            <b-link v-if="facebook" :href="facebook" class="btn venue-facebook" target="_blank" rel="noreferrer">
              <svg class="venue-social__icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <b-link v-if="instagram" :href="instagram" class="btn venue-instagram" target="_blank" rel="noreferrer">
              <svg class="venue-social__icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <b-link v-if="twitter" :href="twitter" class="btn venue-twitter" target="_blank" rel="noreferrer">
              <svg class="venue-social__icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
